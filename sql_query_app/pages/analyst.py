...
st.set_page_config(page_title="Analyste - Exécution des requêtes", layout="wide", initial_sidebar_state="expanded")
auth.logout_button()

# ==============================
# Interface Analyste
# ==============================
st.title("📊 Interface Analyste - Exécution des requêtes")
...
with st.expander("❓ Aide et instructions"):
    ...
    - Contactez l'administrateur si une requête ne fonctionne pas
